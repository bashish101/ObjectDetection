...
class YoloV4(nn.Module):
    def __init__(self,
        ...
        self.pre_head_32, self.mid_head_32, self.post_head_32, self.out_head_32  = self._create_head_32([1024, 2048, 1024]) 
    ...
    def _create_head_32(self, in_filters_list):        
        ...
        return nn.Sequential(*pre_layers), nn.Sequential(*mid_layers), nn.Sequential(*post_layers), nn.Sequential(*out_layers)
